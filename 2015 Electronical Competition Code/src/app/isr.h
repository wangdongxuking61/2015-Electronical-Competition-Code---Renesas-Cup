...
#undef  VECTOR_064                        //要先取消了，因为在vectors.h里默认是定义为 default_isr  
#define VECTOR_064    USART0_IRQHandler   //重新定义63号中断的ISR：UART1：Single interrupt vector for UART status sources
...
#undef  VECTOR_106
#define VECTOR_106    VSYNC_IRQ           //重新定义106号中断为VSYNC_IRQ中断 
